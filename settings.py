...
NEIGHBORHOODS = ["mission", "mission bay", "dogpatch", "soma", "emeryville", "cow hollow", "south beach", "pac hts", "pacific heights", "lower haight", "inner sunset", "outer sunset", "presidio", "castro", "haight ashbury", "twin peaks", "noe valley", "bernal heights", "glen park", "sunset", "mission district", "potrero hill"]
